/* American Studies OST Mastery — Shared Question Bank
   ...
   - Must define global: const AMSTUD_BANK = [...]
   - We also mirror to: window.AMSTUD_BANK for debugging/compat
*/
...
const AMSTUD_BANK = [
  ...
  // =========================================================
  {
    ...
    tag: "Cause & Effect",
    stem:
      "A historian claims a political cartoon from 1890 proves that all Americans supported new immigration restrictions. Which detail most weakens the historian’s conclusion?",
    choices: [
    ...
    answerIndex: 1,
    hint:
      "Credibility and causation claims collapse when the evidence is too narrow to represent the whole population.",
    explain:
      "A single cartoon shows one perspective; it cannot by itself prove nationwide public agreement."
  },
  {
    cs: "CS 2 – Analyzing Primary & Secondary Sources",
    tag: "Cause & Effect",
    stem:
      "A textbook chapter argues that a strike failed mainly because workers were “unpatriotic.” What is the best next step to evaluate that cause-and-effect claim?",
    choices: [
    ...
    answerIndex: 1,
    hint:
      "Test cause-and-effect claims by corroborating with multiple sources, especially primary evidence.",
    explain:
      "Corroborating with primary sources helps verify whether the author’s explanation fits the evidence."
  },
  {
    cs: "CS 3 – Cause, Effect, and Sequence",
    tag: "Cause & Effect",
    stem:
      "Which factor most directly contributed to the rapid growth of cities in the late 1800s?",
    choices: [
    ...
    explain:
      "Industrial jobs and transportation (railroads/streetcars) pulled people into urban centers."
  },
  {
    ...
    explain:
      "Rapid urban growth exposed corruption, unsafe conditions, and health crises that reformers targeted."
  },
  {
    cs: "CS 5 – Multiple Perspectives",
    tag: "Cause & Effect",
    stem:
      "Which explanation best accounts for why industrialists and labor leaders often disagreed about strikes?",
    choices: [
  ...
  },
  {
    ...
    tag: "Cause & Effect",
    stem:
      "Which development most directly helped corporations expand into national businesses during the late 1800s?",
    choices: [
    ...
    explain:
      "Railroads and communication allowed businesses to reach customers and move goods nationwide."
  },
  {
    ...
    explain:
      "Poor conditions and limited worker power pushed laborers to organize for change."
  },
  {
    ...
    explain:
      "Minimal regulation enabled trusts and monopolies to expand and dominate industries."
  },
  {
    cs: "CS 9 – Technological Innovation & Standard of Living",
    tag: "Cause & Effect",
    stem:
      "Which was a major effect of new technologies such as electric lighting and household appliances in the early 1900s?",
    choices: [
  ...
  },
  {
    ...
    tag: "Cause & Effect",
    stem:
      "Progressive Era reforms such as food and drug regulation were most directly caused by:",
    choices: [
  ...
  },
  {
    ...
    tag: "Cause & Effect",
    stem:
      "Which factor most contributed to the success of the women’s suffrage movement by 1920?",
    choices: [
  ...
  },
  {
    ...
    explain:
      "Speculation and structural weaknesses contributed to collapse and widespread unemployment."
  },
  {
  ...
  },
  {
    ...
    explain:
      "Postwar demand and expanded opportunities helped fuel growth and a higher standard of living."
  },
  {
  ...
  },
  {
    ...
    explain:
      "Globalization increased competition and incentivized some companies to move production, reshaping jobs."
  },
  {
    ...
    explain:
      "Expanded trade and global supply chains made the U.S. economy more connected to global events."
  },
  {
    cs: "CS 33 – Struggles for Equality & Civil Rights Expansion (1945–1994)",
    tag: "Cause & Effect",
    stem:
      "How did federal legislation such as the Civil Rights Act (1964) and Voting Rights Act (1965) most directly affect U.S. society?",
    choices: [
    ...
    explain:
      "These laws expanded protections and enforcement against discrimination and voting barriers."
  },
  ...
  // =========================================================
  {
    ...
    type: "select-two",
    stem:
      "Select TWO reasons a single diary entry is limited evidence for proving that “most Americans” supported a policy.",
    choices: [
  ...
  },
  {
    ...
    type: "select-two",
    stem:
      "Select TWO examples of primary sources a historian could use to study urban living conditions around 1900.",
    choices: [
  ...
  },
  {
    ...
    explain:
      "Federal laws strengthened enforcement against discrimination and barriers to voting."
  },
  ...
  // Existing 12
  {
    ...
    stem:
      "Put these developments in the most logical sequence that helps explain how corporations became national businesses. Then identify the turning point.",
    events: [
    ...
    explain:
      "Railroads connect regions. That connection is the turning point that allows scale, distribution, and national corporate growth."
  },
  {
    id: "G4-002",
    csNum: 7,
    ...
    type: "sequence-turning-point",
    stem:
      "Sequence the chain that explains why unions gained influence. Then identify the turning point.",
    events: [
    ...
    explain:
      "Conditions existed before. Union organization changes the balance of power and makes collective pressure possible."
  },
  {
    id: "G4-003",
    csNum: 8,
    ...
    type: "sequence-turning-point",
    stem:
      "Order the cause-and-effect sequence describing how laissez-faire attitudes helped trusts form. Then identify the turning point.",
    events: [
    ...
    explain:
      "Minimal regulation made consolidation easier and helped trusts form and dominate."
  },
  {
    id: "G4-004",
    csNum: 10,
    ...
    type: "sequence-turning-point",
    stem:
      "Sequence what typically happened in fast-growing cities around 1900. Then identify the turning point.",
    events: [
    ...
    explain:
      "Mass migration/immigration is the turning point that strains infrastructure and creates urgent reform pressures."
  },
  {
    id: "G4-005",
    csNum: 11,
    ...
    type: "sequence-turning-point",
    stem:
      "Put the Progressive reform pattern in order. Then identify the turning point.",
    events: [
    ...
    explain:
      "Muckrakers exposing abuse is often the turning point that converts hidden problems into political action."
  },
  {
    id: "G4-006",
    csNum: 14,
    ...
    type: "sequence-turning-point",
    stem:
      "Sequence the path from WWI ending to U.S. rejection of the Treaty of Versailles. Then identify the turning point.",
    events: [
    ...
    explain:
      "The League commitment is the turning point that sparks Senate opposition and drives rejection."
  },
  {
    id: "G4-007",
    csNum: 15,
    ...
    type: "sequence-turning-point",
    stem:
      "Sequence how the U.S. tried to avoid another war in the 1930s. Then identify the turning point.",
    events: [
    ...
    explain:
      "Neutrality laws are the turning point because they formalize isolationist strategy before later erosion."
  },
  {
    id: "G4-008",
    csNum: 16,
